...
from fastapi_app.app.schemas import OrderCreateSchema, OrderUpdateSchema
from fastapi_app.app.database import Session, ENGINE
from fastapi_app.app.models import Admin, Order, Client
...
async def create_furniture(request: OrderCreateSchema, Authorization: AuthJWT = Depends()):
    try:
        Authorization.jwt_required()
    except Exception as e:
        raise HTTPException(status_code=status.HTTP_401_UNAUTHORIZED, detail="Invalid token")
            ...
            for key, value in order.dict().items():
                ...
                data = {
                    ...
                    "object": {
                        ...
                        "furniture_id": check_order.furniture_id,
